...
function cekjawab(X){
    if(X == 1){
        ...
        else if(a[0].checked && a[4].checked){
            pembahasan[4].className = pembahasan[4].className.replace(' hilang', '');
            if(pembahasan[5].className.indexOf('hilang') == -1){
                pembahasan[5].className += ' hilang';
            }
        }else{
            pembahasan[5].className = pembahasan[5].className.replace(' hilang', '');
            if(pembahasan[4].className.indexOf('hilang') == -1){
                pembahasan[4].className += ' hilang';
            }
...
function soalTampil(n) {
  ...
  if (n < 1){
    ...
    if(slideIndex-1 == 0 || slideIndex-1 == 1 || slideIndex-1 == 3){
        for(let i=0; i<3; i++){
            for(let j=0; j<pilihan[i].children.length; j++){
                pilihan[i].children[j].style.pointerEvents="auto";
                pilihan[i].children[j].className='op'+[i+1];
