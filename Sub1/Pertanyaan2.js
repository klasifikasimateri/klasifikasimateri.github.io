...
function benar(X){
    ...
    if(X == 3){
        document.getElementById("op10").className += " benar";
...
function salah(X){
    ...
    if(X == 8){
        document.getElementById("op11").className += " salah";
        pembahasan[9].className = pembahasan[9].className.replace(' hilang', '');
        tombol[2].className = tombol[2].className.replace(' hilang', '');
        for(let i=0;i<pilihan[2].children.length;i++){
            pilihan[2].children[i].style.pointerEvents="none";
...
function cekjawab(X){
    if(X == 1){
        ...
        else if(a[1].checked && a[3].checked){
        ...
        else if (b[0].checked && b[1].checked){
            pembahasan[2].className = pembahasan[0].className.replace(' hilang', '');
            if(pembahasan[3].className.indexOf('hilang') == -1){
                pembahasan[3].className += ' hilang';
            }
        }else{
            pembahasan[3].className = pembahasan[1].className.replace(' hilang', '');
            if(pembahasan[2].className.indexOf('hilang') == -1){
                pembahasan[2].className += ' hilang';
            }
